<template>
  <div class="login">
    <el-form ref="loginForm" :model="loginForm" :rules="rules" label-width="0px" class="login-box">
      <h2 class="login-title">系统登录</h2>
      <el-form-item label="" prop="username">
        <el-input v-model="loginForm.username" type="text" size="arge" placeholder="账号"/>
      </el-form-item>
      <el-form-item label="" prop="password">
        <el-input v-model="loginForm.password" type="password" size="arge" placeholder="密码"/>
      </el-form-item>
      <el-form-item label="" prop="captcha">
        <el-row :gutter="20">
          <el-col :span="14">
            <el-input v-model="loginForm.captcha" type="text" size="arge" clearable placeholder="验证码,单击图片刷新"/>
          </el-col>
          <el-col :span="10">
            <el-image id="imagecode" :src="checkCodeSrc" @click="reloadCode"/>
          </el-col>
        </el-row>
      </el-form-item>
      <el-form-item>
