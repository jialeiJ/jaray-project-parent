    ...
    <div>
      <div id="table">
        <div style="float: right;margin-bottom: 10px">
          ...
          <el-button v-if="false" type="success" plain @click="addSysLog">增加</el-button>
          <el-button v-if="false" type="danger" plain @click="deleteSysLog">删除</el-button>
          <el-button type="danger" plain @click="addSysLog">数据库配置</el-button>
        </div>
        <i-table
          ref="iTable"
      ...
      <!-- 新增 -->
      <add-sys-log ref="addSysLog"/>

      <!-- 详情 -->
      <view-sys-log ref="viewSysLog"/>

      <!-- 编辑 -->
      <edit-sys-log ref="editSysLog"/>
    </div>
  </div>
</template>
