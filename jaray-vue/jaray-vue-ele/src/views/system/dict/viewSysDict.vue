  ...
  <div id="view">
    <el-dialog :visible.sync="viewDialogFormVisible" title="详情">
      <el-form :model="viewForm">
        ...
        <el-form-item :label-width="formLabelWidth" label="标签值">
          <el-input v-model="viewForm.label" readonly="readonly"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="数据值">
          <el-input v-model="viewForm.value" readonly="readonly"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="类型">
          <el-input v-model="viewForm.type" readonly="readonly"/>
        </el-form-item>
        <el-form-item :label-width="formLabelWidth" label="备注">
          <el-input v-model="viewForm.remarks" readonly="readonly"/>
        </el-form-item>
