    ...
    <div>
      <div id="table">
        <div style="margin-bottom: 10px">
          ...
          <el-button v-if="hasPermission('sys:dict:add')" type="success" plain @click="addSysDict">增加</el-button>
          <el-button v-if="hasPermission('sys:dict:delete')" type="danger" plain @click="deleteSysDict">删除</el-button>
        </div>
        <i-table
          ref="iTable"
      ...
      <!-- 新增 -->
      <add-sys-dict ref="addSysDict"/>

      <!-- 详情 -->
      <view-sys-dict ref="viewSysDict"/>

      <!-- 新增 -->
      <edit-sys-dict ref="editSysDict"/>
    </div>
  </div>
</template>
