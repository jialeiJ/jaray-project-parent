    ...
    <div>
      <div id="table">
        <div style="margin-bottom: 10px">
          ...
          <a-button v-if="hasPermission('sys:dict:add')" type="success" plain @click="addSysDict">增加</a-button>
          <a-button v-if="hasPermission('sys:dict:delete')" type="danger" plain @click="deleteSysDict">删除</a-button>
        </div>
        <i-table
          ref="iTable"
