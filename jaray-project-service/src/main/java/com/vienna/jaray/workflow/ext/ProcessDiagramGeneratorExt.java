package com.vienna.jaray.workflow.ext;
...
@Slf4j
@Configuration
public class ProcessDiagramGeneratorExt implements ProcessDiagramGenerator {
     ...
     */
    public ProcessDiagramGeneratorExt(final double scaleFactor) {
        // start event
        activityDrawInstructions.put(StartEvent.class, new ActivityDrawInstruction() {

            @Override
            public void draw(ProcessDiagramCanvasExt processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
        ...
        artifactDrawInstructions.put(TextAnnotation.class, new ArtifactDrawInstruction() {
            ...
            @Override
			public void draw(ProcessDiagramCanvasExt processDiagramCanvas, BpmnModel bpmnModel, Artifact artifact) {
    ...
    protected ProcessDiagramCanvasExt generateProcessDiagram(BpmnModel bpmnModel, String imageType,
    	...
    	ProcessDiagramCanvasExt processDiagramCanvas = initProcessDiagramCanvas(bpmnModel, imageType,
     ...
     * @author Fuxs
     */
    protected void drawActivity(ProcessDiagramCanvasExt processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode,
                                List<String> highLightedActivities, List<String> runningActivitiIdList, List<String> highLightedFlows,
                                double scaleFactor) {
...
//				}
     ...
     * @return
     */
    protected static List<GraphicInfo> connectionPerfectionizer(ProcessDiagramCanvasExt processDiagramCanvas,
        ...
        ProcessDiagramCanvasExt.SHAPE_TYPE sourceShapeType = getShapeType(sourceElement);
        ProcessDiagramCanvasExt.SHAPE_TYPE targetShapeType = getShapeType(targetElement);
     ...
     */
    protected static ProcessDiagramCanvasExt.SHAPE_TYPE getShapeType(BaseElement baseElement) {
        if (baseElement instanceof Task || baseElement instanceof Activity || baseElement instanceof TextAnnotation) {
            return ProcessDiagramCanvasExt.SHAPE_TYPE.Rectangle;
        } else if (baseElement instanceof Gateway) {
            return ProcessDiagramCanvasExt.SHAPE_TYPE.Rhombus;
        } else if (baseElement instanceof Event) {
            return ProcessDiagramCanvasExt.SHAPE_TYPE.Ellipse;
        } else {
    ...
    protected void drawArtifact(ProcessDiagramCanvasExt processDiagramCanvas, BpmnModel bpmnModel,
                                Artifact artifact) {
    ...
    private static void drawHighLight(ProcessDiagramCanvasExt processDiagramCanvas, GraphicInfo graphicInfo) {
     ...
     * @author Fuxs
     */
    private static void drawRunningActivitiHighLight(ProcessDiagramCanvasExt processDiagramCanvas, GraphicInfo graphicInfo) {
    ...
    protected static ProcessDiagramCanvasExt initProcessDiagramCanvas(BpmnModel bpmnModel, String imageType,
        ...
        return new ProcessDiagramCanvasExt((int) maxX + 10, (int) maxY + 10, (int) minX, (int) minY, imageType,
                activityFontName, labelFontName, customClassLoader);
    }
    ...
    protected interface ActivityDrawInstruction {
        ...
        void draw(ProcessDiagramCanvasExt processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode);
    }

    protected interface ArtifactDrawInstruction {

        void draw(ProcessDiagramCanvasExt processDiagramCanvas, BpmnModel bpmnModel, Artifact artifact);
    }
