...
import com.vienna.jaray.workflow.ext.ProcessDiagramGeneratorExt;
...
public class WorkflowImageServiceImpl implements WorkflowImageService {
     ...
     */
    @Override
    public byte[] getFlowImgByProcInstId(String processInstanceId) throws Exception {
        ...
        try {
            // 通过流程实例ID获取历史流程实例
            HistoricProcessInstance historicProcessInstance = getHistoricProcInst(processInstanceId);
            ...
            // } else {
            processDiagramGenerator = new ProcessDiagramGeneratorExt();
            // }
            ...
            imageStream = ((ProcessDiagramGeneratorExt) processDiagramGenerator)
